  ...
  return (
    <footer className="mt-auto flex flex-col lg:items-center bg-black text-white text-xs w-full h-fit px-8 py-4 gap-8">
      ...
      <div className='flex justify-between lg:justify-center w-full max-w-7xl'>
        <div>Copyright &copy; HashGuard 2024, All Rights Reserved | <Link href="https://github.com/Omkar982004/hashguard" className='hover:underline underline-offset-2'>Designed & Developed by HashGuard</Link></div>
      </div>
    </footer>
  );
}
